document.addEventListener("DOMContentLoaded", function () {
    ...
    function createWorkCard(work) {
        ...
        tsMain.className = "work-rating";

        tsMain.textContent =
            "TS主役度 " +
            createStars(work.tsMain);

        info.appendChild(tsMain);
        ...
        info.appendChild(recommendation);
